...
const Sidebar = ({ setShowComponent }) => {
  ...
  return (
    <div className="min-h-screen w-72 sticky top-0 p-6 bg-gradient-to-b from-blue-600 via-purple-600 to-pink-500 text-white shadow-2xl transition-all duration-500 ease-in-out">
      {/* Logo/Header */}
